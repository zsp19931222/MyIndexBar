package com.zsp.myindexbar.utils;
...
public abstract class CommonAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    protected ViewGroup mRv;//add by zsp 2016 08 05 ,for 点击事件为了兼容HeaderView FooterView 的Adapter
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        //add by zsp 2016 08 05 begin ,for 点击事件为了兼容HeaderView FooterView 的Adapter
        if (null == mRv) {
            mRv = parent;
        }
        //setListener(parent, viewHolder, viewType);
        //add by zsp 2016 08 05 end ,for 点击事件为了兼容HeaderView FooterView 的Adapter
        return viewHolder;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //add by zsp 2016 08 05 begin 点击事件为了兼容HeaderView FooterView 的Adapter，所以在OnBindViewHolder里，其实性能没有onCreate好
        setListener(position, holder);
        //add by zsp 2016 08 05 end
