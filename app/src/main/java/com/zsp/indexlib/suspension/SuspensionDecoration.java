...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#f00000");
    ...
    public SuspensionDecoration(Context context, List<? extends BaseIndexPinyinBean> datas) {
        ...
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = SizeUtils.dp2px(32);
        mTitleFontSize = SizeUtils.dp2px(14);
...
//            c.restore();//恢复画布到之前保存的状态
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        //我记得Rv的item position在重置时可能为-1.保险点判断一下吧
        if (position > -1) {
            BaseIndexPinyinBean titleCategoryInterface = mDatas.get(position);
            //等于0肯定要有title的,
